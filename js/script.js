...
function generatePoem(event) {
  ...
  let prompt = `Please write me a 4 line poem about ${userEntry.value}. Each line of the poem must begin on a new line using a <br/>. Sign off every poem with <strong>by SheCodes AI 💖</strong> which must be on a separete line by itself`;
